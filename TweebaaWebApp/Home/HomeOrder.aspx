<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeOrder.aspx.cs" Inherits="TweebaaWebApp.Home.HomeOrder" %>
        ...
        <div class="order-main">
            ...
            <div class="collection-select clearfix">
                ...
                <div class="select-box fl pr">
                    <h3 s-data="" id="s-data"> All</h3>
                    <ul class="select-list" style="width:160px;">
                ...
                <span class="fr"><span class="fl">Created on</span>
            ...
            <table width="100%" class="table">
                <tr>
                    <th width="300" style="border-left: #ccc 1px solid;">
                        Product
                    </th>
                    <th width="82">
                        Price($)
               ...
               <%-- <tr>
                    <td colspan="5">
                        <input type="checkbox"  class="all-select-btn" onclick="CheckAll(this)" /><a href="javascript:;">Select all</a> 
                        <a href="javascript:;"  class="button simple">Combine Payment</a>
                        <a href="javascript:;" class="simple button" onclick="Delete()">Delete</a>
                    </td>
                </tr>--%>
                <tr>
                    <td colspan="5" id="tdData">
                    </td>
                </tr>
            </table>
            <%--<div class="page tr">

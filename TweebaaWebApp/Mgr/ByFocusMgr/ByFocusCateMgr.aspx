<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ByFocusCateMgr.aspx.cs" Inherits="TweebaaWebApp.Mgr.ByFocusMgr.ByFocusCateMgr" %>
    ...
    $(function () {
     ...
     <script type="text/javascript">
        ...
        function DoEdit(obj) {
            ...
            $("#txtEditID").val(id);
            var res = TweebaaWebApp.Mgr.ByFocusMgr.ByFocusCateMgr.GetFocusCateInfo(id);
        ...
        function DoSaveAdd() {
            ...
            var res = TweebaaWebApp.Mgr.ByFocusMgr.ByFocusCateMgr.Add(sName, sNote, sActive);
            LoadFocusCate();
            alert(res.value);
        ...
        function DoSaveEdit() {
            ...
            var res = TweebaaWebApp.Mgr.ByFocusMgr.ByFocusCateMgr.Update(sID, sName, sNote, sActive);
            LoadFocusCate();
            alert(res.value);
        }

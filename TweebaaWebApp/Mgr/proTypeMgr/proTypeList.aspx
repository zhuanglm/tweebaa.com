<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proTypeList.aspx.cs" Inherits="TweebaaWebApp.Mgr.proManager.proTypeList" %>
        ...
        <script type="text/javascript">
            ...
            function _delete(obj) {
                if(confirm("Confirm to delete selected？")){
                    ...
                    var res = TweebaaWebApp.Mgr.proManager.proTypeList.DeleteType(id).value;
                    if (res == "success") {
            ...
            function _editSave() {
                ...
                if (id == null || id.length == 0 || name == null || name.length == 0) {
                    ...
                    var res = TweebaaWebApp.Mgr.proManager.proTypeList.UpdateTypeName(id, name).value;
                    if (res == "success") {
            ...
            function _view(obj) {
                ...
                var res = TweebaaWebApp.Mgr.proManager.proTypeList.GetSonTypeName(id).value;
                if (res == "nodata") {

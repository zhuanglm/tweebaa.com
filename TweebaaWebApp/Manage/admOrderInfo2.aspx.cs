...
{
    public partial class admOrderInfo2 : System.Web.UI.Page
    {
        ...
        private void BindOrderInfo(Guid orderGuid)
        {
            ...
            if (OrderInfoDic != null)
            {
                ...
                labRecivePeople.Text = OrderInfoDic["address1"] + OrderInfoDic["recivZipCode"] + "," + OrderInfoDic["reciveName"] + "," + OrderInfoDic["recivePhone"];
                ...
                //收货人信息
                labRecivePeople.Text = OrderInfoDic["reciveName"] + "," + OrderInfoDic["recivePhone"] + "," + OrderInfoDic["address1"];

                labName.Text = OrderInfoDic["userName"].ToString();
                labPhone.Text = OrderInfoDic["userPhone"].ToString();
                labEmail.Text = OrderInfoDic["userEmail"].ToString();
                labPeaopleCode.Text = "";

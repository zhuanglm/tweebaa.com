...
{
    public partial class admPrdCateAdd : System.Web.UI.Page
    {
        ...
        //    if (!string.IsNullOrEmpty(prtGuid))
        //    {
        //        strWher.Append(" prtGuid='" + prtGuid + "'");
        //    }
        //    //select guid,name,layer,prtGuid,idx,wnstate from dbo.wn_prdCate  where 1=1 
        //    PrdCateMgr prdCate = new PrdCateMgr();
        //    parType.DataTextField = "name";
        //    parType.DataValueField = "guid";
        //    parType.DataSource = prdCate.GetPrdCateList(strWher.ToString());
        //    this.parType.DataBind();
        //    parType.Items.Insert(0, "无");

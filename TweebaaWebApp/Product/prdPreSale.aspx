<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="prdPreSale.aspx.cs" Inherits="TweebaaWebApp.Product.prdPreSale" %>
...
<div class="list-banner buy-all">
    ...
    <div class="w964">
        ...
        <div class="select-show clearfix tc">
            ...
            <span><a href="prdPreSale.aspx?step=2" class="on">Limited Time</a> </span>
            ...
            <h2 class="t">
             ...
             <div class="box">
                ...
                <div class="ps clearfix">
                    <span class="fr"><a href="#"></a></span><span class="fl">You will earn <span id="sharePercent"></span> commission when your
                        friend  makes a purchase from your shared link. </span>
                </div>
            </div>         
        </div>
    </div>

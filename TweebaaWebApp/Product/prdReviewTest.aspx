<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prdReviewTest.aspx.cs" Inherits="TweebaaWebApp.Product.prdReviewTest" %>
    ...
    $(function () {
        ...
        function loadMeinv() {
            ...
            for (var i = 0; i < 3; i++) {//每次加载时模拟随机加载图片
				...
				+ i + '.jpg></a></div><div class="water_user">美女小清新_'
				+ i + '</div><div class="water_option"><a href="" class="option_item">收藏 4</a> <span class="split"></span><a href="" class="option_item option_comt">评论 8</a><span class="split"></span><a href="" class="option_item option_relay">转播 124</a></div></li>';
                $minUl = getMinUl();
                $minUl.append(html);
            }
        }

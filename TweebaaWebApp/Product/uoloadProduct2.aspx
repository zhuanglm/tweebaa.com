<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uoloadProduct2.aspx.cs" Inherits="TweebaaWebApp.Product.uoloadProduct2" %>
...
<body>
   ...
   <h3>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<strong>选择产品Excel：</strong>
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:FileUpload ID="FileUpload1" Width="400" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <iframe src="http://192.168.1.10/Server/uploadExcelPic2.aspx" frameborder="0" width="100%"  height="500"></iframe>
    </div>

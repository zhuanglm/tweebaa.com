<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadProduct3.aspx.cs" Inherits="TweebaaWebApp.Product.uploadProduct3" %>
...
<body>
    ...
    <div>
        Upload Error Message: <label id="labError" runat="server"></label><br />
        <h3>
        ...
        <br />
        <asp:Button ID="btnDelete" runat="server" Text="导入新的产品前，请点击此按钮删除已经完成的图片" OnClick="btnDelete_Click" />
        <br /><br />

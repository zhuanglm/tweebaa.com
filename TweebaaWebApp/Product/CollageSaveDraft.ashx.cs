        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (dic["action"].ToString().Equals("save_draft"))
                {
                    ...
                    design.CreateTime = System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss");
                    design.UpdateTime = System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss");
                    design.PublishTime = System.DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss");

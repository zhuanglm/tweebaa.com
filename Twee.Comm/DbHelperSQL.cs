    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string GetSQLConnectionString()
        {
            try
            {
                ...
                {
                    strConn = "Data Source=118.193.145.224; Initial Catalog=TweebaaEn;User Id=sa;Password=Tweebaa@2012!2050@#$2016;max pool size=5000";
                }
                else if (IsSandbox == 3)
                {
                    strConn = "Data Source=67.224.94.82,4108; Initial Catalog=TweebaaEn;User Id=wnTweebaa;Password=Tweebaawebapp2014!2016;max pool size=5000";
                }
                else if (IsSandbox == 4)
                {
                    //Linux CentOS Server
                    strConn = @"Server=118.193.145.224; Network Library=DBMSSOCN;Database=TweebaaEn;User ID=sa;Password=Tweebaa@2012!2050@#$2016;max pool size=5000";
                }
                else
                {
                    strConn = "Data Source=192.168.1.100; Initial Catalog=TweebaaEn;User Id=sa;Password=Tweebaa@2012!2050@#$2016;max pool size=1000";
                }

<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/mstMyAdm.Master"  AutoEventWireup="true" CodeBehind="admPrdReviewMain.aspx.cs" Inherits="TweebaaWebApp.Manage.admPrdReviewMain" %>

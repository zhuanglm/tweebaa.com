...
<table cellpadding="2" cellspacing="2">
      <tr>
        ...
        <td align="left"><input type="text" name="coupon_name" id="coupon_name" value="<%=coupon_name %>" /></td>
        <td align="left" class="main" width="40%">A short name for the coupon</td>
      </tr>
       <tr>
        <td align="left" class="main">Coupon Amount</td>
        <td align="left"><input type="text" name="coupon_amount" id="coupon_amount" value="<%=coupon_amount %>"/></td>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="coupon_min_order" id="coupon_min_order" value="<%=coupon_min_order %>" /></td>
        <td align="left" class="main">The minimum order value before the coupon is valid</td>
      </tr>
      <tr>
        <td align="left" class="main">Free Shipping</td>
        <td align="left"><input type="checkbox" name="coupon_free_ship" id="coupon_free_ship" <%=coupon_free_ship %> /></td>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="coupon_code" id="coupon_code" value="<%=coupon_code %>" /></td>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="coupon_uses_coupon" id="coupon_uses_coupon" value="<%=coupon_uses_coupon %>" /></td>
      ...
      <tr>
        ...
        <td align="left"><input type="text" name="coupon_uses_user" id="coupon_uses_user" value="<%=coupon_uses_user %>" /></td>
...
-->
      <tr>
        ...
        <td align="left"><input type="text" id="txtStartDate" name="txtStartDate" value="<%=txtStartDate %>"  /></td>
        <td align="left" class="main">The date the coupon will be valid from</td>
      </tr>
      <tr>
        <td align="left" class="main">End Date</td>
        <td align="left"><input type="text" id="txtEndDate"  name="txtEndDate" value="<%=txtEndDate %>" /> </td>
...
<script type="text/javascript">
    ...
    function AddEditCoupon() {
        ...
        if (coupon_products == undefined) {
            coupon_products = "";
        }
        var coupon_categories = $("#coupon_categories").val();
        if (coupon_categories == undefined) {
            coupon_categories = "";
        }
        /*
        ...
        $.ajax({
            ...
            success: function (resu) {
                if (resu == 1) {
                    alert("Add OK");
                    window.location.href = "CouponsListMgr.aspx";
                }
            },
            error: function (obj) {
                // alert("Load failed");

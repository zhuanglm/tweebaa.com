<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payCash.aspx.cs" Inherits="TweebaaWebApp.Mgr.userMgr.payCash" %>
    ...
    <script type="text/javascript">
        ...
        function Approval(obj) {
            if (confirm("Confirm to approval?")) {
                ...
                var res = TweebaaWebApp.Mgr.userMgr.payCash.Approval(id, 1).value;
                if (res == "success") {

...
namespace TweebaaWebApp.Mgr.ShipOrderMgr
{
    ...
    public class ShipOrder1 : IHttpHandler
    {
        ...
        private string ShipOrderListGridData(HttpContext context)
        {
            ...
            DataTable dt = mgr.MgeGetShipOrderList(iStartIdx, iEndIdx, out iTotalCount, sShipOrderID, sTweebaaOrderID, sPartnerOrderID, sStartTime, sEndTime, sSuccess);
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                sJson.AppendFormat("{0} \"ShipOrderID\":\"{2}\",\"ShipOrder_ID\":\"{3}\",\"OrderHead_GuidNo\":\"{4}\",\"ShipPartner_Name\":\"{5}\", \"ShipOrder_Date\":\"{6}\" ,\"ShipOrder_Success\":\"{7}\" ,\"ShipOrder_PartnerOrderID\":\"{8}\", \"ShipOrder_ErrMsg\":\"{9}\" {1}",
                    "{",
                    "}",
                    ...
                    row["ShipOrder_ErrMsg"]._ObjToString().Replace(',', '，').Replace("\"", "&quot;")
                    );
            }

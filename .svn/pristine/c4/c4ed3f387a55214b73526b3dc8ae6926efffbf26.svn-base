...
Scrolling.Scroller = function (o, w, h, t) {
	...
	this.scrollTo = function (x, y) { 
		setPosition(-x, -y);
		this.onScroll();
		$(".Scrollbar-Handle-blue").height(parseInt($(".Scrollbar-Handle").css("top")+10))
	};
...
CM.intro = {
	...
	iniScr: function(){
		var scroller  = null;
		var scrollbar = null;//430 -209
		scroller  = new Scrolling.Scroller(document.getElementById('dv_scroll'),430,335);

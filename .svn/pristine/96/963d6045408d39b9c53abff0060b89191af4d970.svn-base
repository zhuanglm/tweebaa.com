...
{
    public partial class product2 : System.Web.UI.UserControl
    {
        ...
        public void GetAll()
        {
            ...
            DataTable dt = prd.MgeGetListSale(prdName, userName, "2", "", startId, endId);
            if (dt != null)
            {
                gridData.DataSource = dt;
                gridData.DataBind();
            }
            AspNetPager1.RecordCount = prd.MgeGetListReviewCount(prdName, userName, "2");

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proUpMgr.aspx.cs" Inherits="TweebaaWebApp.Mgr.proManager.proUpMgr" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#ddlTypeOne").combobox({
                    valueField: 'value',
                    textField: 'text',
                    data: eval(TweebaaWebApp.Mgr.proManager.proUpMgr.GetFirstCate().value),
                    onSelect: function (e) {
                        var selectedId = e.value;
                        $("#ddlTypeTwo").combobox("clear");
                        $("#ddlTypeThree").combobox("clear");
                        if (selectedId != "-1") {
                            var res = TweebaaWebApp.Mgr.proManager.proUpMgr.GetNextCate(selectedId).value;
                            if (res != "fail") {
        ...
        <script type="text/javascript">
            ...
            function passAll() {
                if (confirm("Confirm to approve and add selected products？")) {
                    ...
                    if (checkedItems.length == 0) {
                        ...
                        if (proids.length > 0) {
                            var res = TweebaaWebApp.Mgr.proManager.proUpMgr.PassAll(proids).value;
                            if (res == "success") {
            ...
            function passSingle(obj) {
                if (confirm("Confirm to add selected products？")) {
                    ...
                    if (proid.length > 0) {
                        var res = TweebaaWebApp.Mgr.proManager.proUpMgr.PassSingle(proid).value;
                        if (res == "success") {
                            alert("Evaluate Success！");
                            _search();
                        }
            ...
            function noPassSave() {
                ...
                if (proid == null || reason == null || proid == "" || $.trim(reason) == "") {
                    ...
                    var res = TweebaaWebApp.Mgr.proManager.proUpMgr.NoPass(proid, reason).value;
                    if (res == "success") {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userCash.aspx.cs" Inherits="TweebaaWebApp.Mgr.userMgr.userCash" %>
    ...
    <script type="text/javascript">
        ...
        function Approval(obj) {
            if (confirm("Confirm to approval?")) {
                ...
                var res = TweebaaWebApp.Mgr.userMgr.userCash.Approval(id, 2).value;
                if (res == "success") {

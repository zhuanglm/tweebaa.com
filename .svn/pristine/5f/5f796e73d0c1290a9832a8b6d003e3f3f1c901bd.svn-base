<%@ Page Title=""  Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="TweebaaWebApp2.User.login" %>
...
<link rel="stylesheet" href="/css/pages/log-reg-v3.css"> 
    ...
    <style type="text/css">
      ...
      <% if(browserName!="Safari" && browserName!="InternetExplorer"){ %> 
...
<div id="fb-root"></div>
    ...
    <div class="log-reg-v3 content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-5 md-margin-bottom-50 hidden-col">
                <!-- Magazine Slider -->
            <div class="carousel slide carousel-v2 margin-bottom-40" id="portfolio-carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img class="img-responsive imgcenter" src="/images/submit-login.png?v=20160126" alt="submit">
                          <div class="info-block-in">
                            <h3 class="txtcenter">Plant the seed of your product.</h3>
                            <p class="txtcenter">As a successful suggester you can enjoy the growth <br> of your product and be considered an expert  <br> in finding products while receiving income. </p>
                        </div>    
                    </div>
                    <div class="item">
            ...
            <!-- End Magazine Slider -->
                ...
                <div class="col-md-5 col-sm-offset-1" id="divLoginMain">
                    <form id="sky-form1" class="log-reg-block sky-form" method="post">
                        ...
                        <button class="btn-u btn-u-sea-shop btn-block margin-bottom-20 rounded" onclick="LogionFuc();return false;">Login</button>
                        ...
                        <div class="row columns-space-removes">
                            <div class="col-lg-6 margin-bottom-10" >
                              ...
                              <!-- <button type="button"  onlogin="FBCheckLoginState();" class="btn-u btn-u-md btn-u-fb btn-block fbconnect_login_button"><i class="fa fa-facebook"></i> Facebook Log In</button> --> 
                              

                              <div class="btn-u btn-u-md btn-u-fb btn-block rounded" id="divFBButton"> 
                              <fb:login-button scope="public_profile,email" data-size="large"  onlogin="FBCheckLoginState();">Facebook Login</fb:login-button> 
                            ...
                            <div class="col-lg-6">
                                ...
                                <button type="button" onclick="DoTwitterLogin()" class="btn-u btn-u-md btn-u-tw btn-block rounded"><i class="fa fa-twitter"></i>Twitter Login</button>
                    ...
                    <p class="text-center"> New Account <a href="/User/register.aspx" class="color-blue">Sign Up</a> /  Get activation email  <a href="/User/ResendActivationEMail.aspx" class="color-blue">Resend</a></p>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#divFBButton iframe").contents().find("._4z_f .fwb").html("Facebook Log In");
    });

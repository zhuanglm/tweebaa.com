...
function LoadShipOrderDetail(sShipOrderID) {
    ...
    $.ajax({
        ...
        success: function (resu) {
            ...
            $("#labOrderDate").html(obj.ShipOrder_Date.toLocaleString());
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var dPrice = Math.round((obj.Item_UnitPrice * obj.Item_Quantity * 100) / 100);
                ...
                var sItemHtml = '<tr>' +
                                ...
                                '<td><span class="text">$' + obj.Item_UnitPrice.toFixed(2) + '</span></td>' +

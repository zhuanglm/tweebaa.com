<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shareGradeParam.aspx.cs" Inherits="TweebaaWebApp2.Mgr.userMgr.shareGradeParam" %>
...
<body>
    ...
    <fieldset>
      ...
      <div style="margin: 2px;">
        <table id="dg" title="Share Grade Paramer" style="width: 100%; height: auto">
        </table>
    </div>
    <div id="winView" title="Approve Reason">
        <table id="sonTable" class="tbtable" style="width: 480px;">
            ...
            <tr>
             ...
             <tr>
                <td class="title">
                    <span style="color: red;">*</span>分享区积分奖励所需支访问区间最小值：
                </td>
                <td>
                     <input type="text" id="txtVisitmin" />
                </td>
            </tr>
            <tr>
                <td class="title">
                    <span style="color: red;">*</span>分享区积分奖励所需支访问区间最大值：
                </td>
                <td>
                     <input type="text" id="txtVisitmax" />
                </td>
            </tr>
             <tr>
                <td class="title">
                    <span style="color: red;">*</span>购买奖励积分值：
                </td>
                <td>
                     <input type="text" id="txtBuyreward" />
                </td>
            </tr>             
             <tr>
                <td class="title">
    ...
    <script type="text/javascript">
        var dataGridUrl = 'users.ashx?action=dataShareGrade';
        ...
        $(function () {
            var pager = $('#dg').datagrid({
                ...
                //{ field: 'prdguid', title: '产品ID', width: 80, hidden: true },
                        ...
                        { field: 'visitreward', title: '访问奖励积分值', width: 120, align: 'right' },
                        { field: 'visitcountmin', title: '分享区积分奖励所需支访问区间最小值', width: 160, align: 'right' },
                        { field: 'visitcountmax', title: '分享区积分奖励所需支访问区间最d大值', width: 160, align: 'right' },
                        { field: 'buyreward', title: '购买奖励积分值', width: 120, align: 'right' },
                        { field: 'commissionratio', title: '佣金比例(千分比)', width: 100, align: 'right' },
                        {
        ...
        function DoublePoints() {
            var res = TweebaaWebApp2.Mgr.userMgr.shareGradeParam.DoublePoints().value;
            if (res == "success") {
                alert("Success");    

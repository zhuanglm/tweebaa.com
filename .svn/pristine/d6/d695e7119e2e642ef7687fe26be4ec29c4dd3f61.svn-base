...
namespace Twee.DataMgr
{
    public class AdministratorDataMgr
    {
        ...
        public bool Update_No_Pwd(Twee.Model.MgrUser model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wn_MgrUser set ");
            strSql.Append("MgrUser_Name=@Name,");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = model.sName;
            parameters[1].Value = model.iActive;
            parameters[2].Value = model.iID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update wn_MgrUserGroupType set ");
            strSql.Append("MgrUserGroupType_Name=@Name,");
            strSql.Append("MgrUserGroupType_Description=@Des,");
            strSql.Append("MgrUserGroupType_Active=@Active");
            strSql.Append(" where MgrUserGroupType_ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@Name", SqlDbType.NVarChar,50),
					new SqlParameter("@Des", SqlDbType.NVarChar,250),
					new SqlParameter("@Active", SqlDbType.TinyInt, 1),
					new SqlParameter("@ID", SqlDbType.Int,4)};
            parameters[0].Value = model.sName;
        ...
        public DataTable GetUserFunctionTable(int iMgrUserID)
        {

<%@ Page Title=""  Language="C#" MasterPageFile="~/Manage/mstMyAdm.Master"  AutoEventWireup="true" CodeBehind="admPrdSale.aspx.cs" Inherits="TweebaaWebApp2.Manage.admPrdSale" %>

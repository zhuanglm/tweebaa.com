<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shareGradeParam.aspx.cs" Inherits="TweebaaWebApp.Mgr.userMgr.shareGradeParam" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function DoublePoints() {
            var res = TweebaaWebApp.Mgr.userMgr.shareGradeParam.DoublePoints().value;
            if (res == "success") {
                alert("Success");    

<%@ Page Title=""  Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="HomeOrderDetailSupplier.aspx.cs" Inherits="TweebaaWebApp2.Home.HomeOrderDetailSupplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="WebCssAndJs" runat="server">
	...
	<script type="text/javascript" src="../MethodJs/homeOrderDetailSupplier.js"></script>
</asp:Content>
    ...
    <div class="details-main"><!--safe-main-->
      <h2 class="t">ORDER INFORMATION DETAILS</h2>
        <div class="section clearfix">
            ...
            <p><strong>Order Status: </strong> <span class="f14 blue" id="labShipOrderStatus"></span></p>
            <p><strong>Shipping Method： </strong><span id="labShipMethod"></span></p>    
            <p><strong>Tracking Number：</strong><span id="labTrackingNo" class="f14 blue"></span></p>
        </div>
                <br />
        <div class="section  clearfix">    
        ...
        <div class="section  clearfix">
           ...
           <table width="100%" class="table" id="tbItemList">

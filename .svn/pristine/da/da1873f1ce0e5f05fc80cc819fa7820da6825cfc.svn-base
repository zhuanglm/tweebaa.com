...
namespace TweebaaWebApp.upload
{
    public partial class picUploadNew : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            try
            {
                //Twee.Comm.CommHelper.WrtLog("11");
                if (fileUploadPic.HasFile)
                {
                    ...
                    //Twee.Comm.CommHelper.WrtLog("22");
                    string pathTemp = Server.MapPath("~" + "/" + savePath + "temp/" + folderName + "/");
                    ...
                    //{                                       
                    //Twee.Comm.CommHelper.WrtLog("33");
                        ...
                        //Twee.Comm.CommHelper.WrtLog("44");
                        hidBigFilePath.Value = newFileName;//给前台写入文件新名称                      
                        Image1.ImageUrl = "/upload/UploadImg/temp/" + folderName + "/" + newFileName;
                        hidTip.Value = "/upload/UploadImg/temp/" + folderName + "/" + newFileName;

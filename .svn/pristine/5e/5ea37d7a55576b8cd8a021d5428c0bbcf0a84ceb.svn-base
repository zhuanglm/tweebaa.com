<%@ Page Title=""  Language="C#" MasterPageFile="~/Manage/mstMyAdm.Master"  AutoEventWireup="true" CodeBehind="admUserInfo.aspx.cs" Inherits="TweebaaWebApp2.Manage.admUserInfo" %>

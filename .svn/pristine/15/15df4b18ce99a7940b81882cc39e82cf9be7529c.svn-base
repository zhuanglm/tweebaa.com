...
{
    public class FosdickOrderReturnReq
    {
        ...
        public DateTime? dtReturnedSince { set; get; }      // Only retrieve returns since
        public DateTime? dtReturnedBefore { set; get; }     // Only retrieve returns before
    }
}
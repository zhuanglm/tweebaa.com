<%@ Page Title=""  Language="C#" MasterPageFile="~/Manage/mstMyAdm.Master"  AutoEventWireup="true" CodeBehind="admPrdCateAdd.aspx.cs" Inherits="TweebaaWebApp2.Manage.admPrdCateAdd" %>

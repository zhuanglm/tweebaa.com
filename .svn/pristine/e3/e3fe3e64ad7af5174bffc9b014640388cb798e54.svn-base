...
<asp:Content ID="Content2" ContentPlaceHolderID="WebCssAndJs" runat="server">
	...
	<script type="text/javascript" src="/js/CollageDesign.js?v=201602103" ></script>
    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                ...
                <li><a href="/Product/CollageShare.aspx">Share</a></li>
  ...
  <div class="container">
    ...
    <input type="hidden" id="DesignIsValid" value="<%=IsValidID %>" />
			...
			<input type="hidden" id="txtShareID" name="txtShareID" value="<%=shareID %>" />
                  ...
                  <button class="btn-u btn-u-lg rounded-4x btn-u-share margin-bottom-15 color-white" id="link_share_earn" type="button">Share & Earn</button>
                 <%=AdminButton %>
                 
                        <div class="alert alert-warning fade in">
                      <h4>Want to bulid your own collage? </h4>
			    <button class="btn-u btn-brd rounded-4x btn-u-yellow btn-u-sm" onclick="window.location.href='/Product/collage.aspx'" type="button">Create New Collage</button>
			    <div class=" margin-bottom-10"></div>
			       <h4>Or Download our APP now </h4>

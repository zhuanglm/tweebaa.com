<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Manage/mstMyAdm.Master" CodeBehind="admArticleType.aspx.cs" Inherits="TweebaaWebApp2.Manage.Article.admArticleType" %>

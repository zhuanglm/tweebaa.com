        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (dic["action"].Equals("load_decoration_total"))
                {
                    ...
                    int iTotal = mgr.GetDecorationImgTotal("CollageDecorationImg_IsActive="+sType);
                ...
                if (dic["action"].Equals("load_decoration"))
                {
                    ...
                    string sPageDiv = dic["pageDiv"].ToString();
                    string sType = dic["type"].ToString();
                    List<Twee.Model.CollageDecorationImg> DecorationImg = mgr.GetDecorationImg(sPage, sPageDiv, "CollageDecorationImg_IsActive=" + sType);
                ...
                if (dic["action"].Equals("load_artise_total"))
                {
                ...
                if (dic["action"].Equals("load_artise"))
                {
                    string sPage = dic["page"].ToString();
                    string sPageDiv = dic["pageDiv"].ToString();

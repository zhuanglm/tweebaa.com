...
{ 
    public class WarehouseMgr
    {
        ...
        public void ProductSend()
        {
            ...
            dicSkus.Add("product_code", "20141231012050");// Y商品条码
            ...
            dicSkus.Add("has_barcode", "");// 1 实物有条码  0  没有条码
        ...
        public void PushPurchase()
        {
            ...
            dicPurchase.Add("purchase_no", "10811085");//Y采购单号
            dicPurchase.Add("transporter_id", "230096");//运输商
            dicPurchase.Add("out_sid", "");// 运单号
            dicPurchase.Add("supplier_id", "");// 供应商ID
            dicPurchase.Add("create_date", DateTime.Now.ToString().Replace("/", "-"));// Y建立日期
            dicPurchase.Add("plan_ship_date", "2014-01-06");// Y计划发货日期
            dicPurchase.Add("plan_arrival_date", "2014-01-08");// Y计划到货日期
            dicPurchase.Add("remark", "尺寸");// 备注
            dicPurchase.Add("audit_date", "2014-01-09");// Y审核日期
            dicSkus.Add("product_code", "20141231012051");// Y商品条码
            dicSkus.Add("qty", "1000");// Y数量
            dicSkus.Add("unit_purchase_cost", "88");//单位价格     
            WarehouseInterface warehouse = new WarehouseInterface();
        ...
        public void InventoryQuery()
        {
            ...
            dicInventoryQuery.Add("owner_id", ShopId);
            dicInventoryQuery.Add("product_code", "20141231012050");   //20141231012050
        ...
        private void SendOrder()
        {
            ...
            Dictionary<string, string> dicSkus = new Dictionary<string, string>();
            string product_code = "20141231012050";//条码
            string order_no = "201412310001";
            string count = "1";
            ...
            dicTrades.Add("out_sid", "20140808055");//快点单号

            dicSkus.Add("product_code", product_code);//Y条码
            dicSkus.Add("qty", "10");//Y数量
            ...
            dicSkus.Add("sell_price", "50");//购买单价
        ...
        private void OrderDeliverQuery()
        {
            ...
            dicDeliverQuery.Add("end_date", "2014-12-31 19:33:12");// 
        ...
        private void OrderStateQuery()
        {
            ...
            dicOrders.Add("begin_create_date", "");// 格式2012-10-31 17:45:40 ;对应订单中日期 规则：1. BEGIN_DATE有值时End_DATE必填 2ORDER_NO和｛BEGIN _ DATE,End _DATE｝必填一个
            dicOrders.Add("end_create_date", "");// 
            dicOrders.Add("page_no", "");// 页码
            dicOrders.Add("page_size", "");// 每页行数
            Twee.Comm.WarehouseInterface warehouse = new Twee.Comm.WarehouseInterface();

...
namespace Twee.Mgr
{
    ...
    {
        private readonly Twee.DataMgr.TemplateDataMgr mgr = new DataMgr.TemplateDataMgr();
        public TemplateMgr()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Template GetModelByCache(int id)
        {

            string CacheKey = "TemplateMgrModel-" + id;
        ...
        {
            List<Template> modelList = new List<Template>();
        ...
        {
            DataSet ds =mgr.GetListByPage(strWhere, orderby, startIndex, endIndex);
            return ds;
        }
        /// <summary>
        /// 分页获取数据列表

        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (sGet.Equals("Save_Collage"))
                {
                     ...
                     * 
                     * "IMG=/CollageImg/2015_08_17_10_34_14.png&SaveType=2&Designer=eff4dca6-fedc-4bd9-bbe5-79dec2bb39d8&ItemTotal=1&img1=UploadImg/mid2/20150606/20150606191456_7770.png&x1=142.259003&y1=459.736755&s1=1.000000&a1=0.000000&p1=3d7aeec0-5ece-4fad-975c-a58ef9464af1"
                     * 
                    */

                    String sCollage = context.Request.Form["collage"];
                    String[] sFormData = sCollage.Split('&');


                    String sImg = sFormData[0].Split('=')[1]; //0
                    String sSaveType = sFormData[1].Split('=')[1]; //1 
                    String sDesigner = sFormData[2].Split('=')[1]; //2 
                     
                    String sItemTotal = sFormData[3].Split('=')[1]; //3
            ...
            [9]	"p1=3d7aeec0-5ece-4fad-975c-a58ef9464af1"	string
                ...
                if (sGet.Equals("load_my_favour"))
                {
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        List<Twee.Model.CollageDesign> templates = mgr.GetListByPage("CollageDesign_ID in ("+sIDs+") and CollageDesign_Status=0", iFirst, iLast);
                        //make xml

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="HomeReferral.aspx.cs" Inherits="TweebaaWebApp2.Home.HomeReferral" %>
<asp:Content ID="Content1" ContentPlaceHolderID="WebTitle" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="WebCssAndJs" runat="server">    <link rel="stylesheet" href="../css/style.css">
    ...
    <script src="../MethodJs/HomeReferral.js?v=20160205" type="text/javascript"></script>
     <%--分页--%>    

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proSaleMgr.aspx.cs" Inherits="TweebaaWebApp.Mgr.proManager.proSaleMgr" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#ddlTypeOne").combobox({
                    valueField: 'value',
                    textField: 'text',
                    data: eval(TweebaaWebApp.Mgr.proManager.proSaleMgr.GetFirstCate().value),
                    onSelect: function (e) {
                        var selectedId = e.value;
                        $("#ddlTypeTwo").combobox("clear");
                        $("#ddlTypeThree").combobox("clear");
                        if (selectedId != "-1") {
                            var res = TweebaaWebApp.Mgr.proManager.proSaleMgr.GetNextCate(selectedId).value;
                            if (res != "fail") {
            ...
            function noPassSave() {
                ...
                if (proid == null || reason == null || proid == "" || $.trim(reason) == "") {
                    ...
                    if ($("#nopassReason").attr('tip') == 'all') {
                        res = TweebaaWebApp.Mgr.proManager.proSaleMgr.DownAll(proid, reason).value;
                    } else {
                        res = TweebaaWebApp.Mgr.proManager.proSaleMgr.DownSaleSingle(proid, reason).value;
                    }

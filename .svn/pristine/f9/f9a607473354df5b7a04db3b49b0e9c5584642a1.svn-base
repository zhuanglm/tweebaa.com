	  ...
	  <div class="row">
                    <div class="col-md-6">
                        <div class="alert alert-info fade in">
                            ...
                            <p>
                                <a class="btn-u btn-u-xs btn-u-default" href="#"><i class="fa fa-cog"></i> Take this action</a> 
                                <a class="btn-u btn-u-xs btn-u-dark" href="#"><i class="fa fa-flask"></i> Or do this</a>
                            </p>
                        </div>
                    </div>
                            ...
                            <ul class="list-inline total-result">
                                ...
                                <li class="total-price">
                                    ...
                                    <div class="total-result-in row" style="font: 15px;">
                                     ...
                                     <div class="col-sm-6">
                                             <button type="button" class="btn-u btn-u-white rounded" onclick="window.location.href='/Product/prdSaleAll.aspx'">
                               Continue Shopping</button>
                                               <button type="button" class="btn-u btn-u-blue rounded" onclick="CreateOrder()">

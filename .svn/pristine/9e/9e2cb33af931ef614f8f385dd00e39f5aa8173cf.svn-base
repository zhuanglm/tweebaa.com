<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="product.ascx.cs" Inherits="TweebaaWebApp2.Manage.Ascx.product" %>
...
<asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="gridData"
    ...
    <Columns>
            ...
            <ItemTemplate>
                <div style="float: left; width: 100%;">
                    <div style="float: left; width: 30%;">                     
                        <a href="../reviewproduct/<%#Eval("idx") %>" target="_blank">
        ...
        <asp:BoundField DataField="txtTag" HeaderText="标签" ItemStyle-Width="10%" Visible="false" />

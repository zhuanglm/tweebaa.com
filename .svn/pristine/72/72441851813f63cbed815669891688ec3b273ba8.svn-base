<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="product2.ascx.cs" Inherits="TweebaaWebApp2.Manage.Ascx.product2" %>
...
<asp:GridView ID="gridData" runat="server" AutoGenerateColumns="false" CssClass="gridData"
    ...
    <Columns>
        <asp:TemplateField HeaderText="操作" ItemStyle-VerticalAlign="Middle" ItemStyle-Width="10%">
            <ItemTemplate>
                <%-- <a href="" title="产品详情" style=" background-image:url(./css/xiangqing.png); background-repeat:no-repeat; display:inline-block; height:20px; width:20px;">&nbsp;</a>--%>
                <a href="../wnAdmin/admPrdSale.aspx?state=2&id=<%#Eval("prdguid") %>" title="预售详情"
            ...
            <ItemTemplate>
                <div style="float: left; width: 100%;">
                    <div style="float: left; width: 35%; text-align: right;">
                      <a href="../presaleproduct/<%#Eval("idx") %>" target="_blank">
        ...
        <asp:BoundField DataField="count" HeaderText="预订数量" ItemStyle-Width="15%" />

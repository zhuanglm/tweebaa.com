...
function revslider_showDoubleJqueryError(e) {
    ...
    t = "<span style='font-size:30px;color:#BC0C06;'>" + t + "</span>";
    ...
    function r(r, i) {
        ...
        if (!r.hasClass("revslider-initialised")) {
            ...
            var b = e.fn.jquery.split("."),
                ...
                S = parseFloat(b[2] || "0");
            if (w == 1 && E < 7) {
                r.html('<div style="text-align:center; padding:40px 0px; font-size:36px; color:#992222;"> The Current Version of jQuery:' + b + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>")
            }
            if (w > 1) i.ie = false;
            ...
            e(window).on(j, function() {
                ...
                if (e("body").find(r) != 0)
                    if (i.forceFullWidth == "on") {
                        ...
                        i.container.parent().css({ left: 0 - n + "px",
                            width: e(window).width()
                        })
                    }
    ...
    var L = function(n, r, i, s, o, u) {
        ...
        if (f == 2) {
            ...
            u.find(".slotslide").each(function() {
                var t = e(this);
                _.add(punchgs.TweenLite.from(t, N / 1e3, { left: 0 - r.slotw,
                    force3D: "auto",
                    rotation: r.rotate
                }), 0);
                C.add(_, 0)
        ...
        if (f == 7) {
            ...
            o.find(".slotslide").each(function() {
                ...
                _.add(punchgs.TweenLite.to(t, N / 1e3, { left: 0 - r.slotw / 2 + "px",
                    top: 0 - r.height / 2 + "px",
                    width: r.slotw * 2 + "px",
            ...
            u.find(".slotslide").each(function(t) {
                ...
                _.add(punchgs.TweenLite.fromTo(n, N / 1e3, { left: 0,
                    top: 0,
                    opacity: 0,
                    transformPerspective: 600
                }, { left: 0 - t * r.slotw + "px",
        ...
        if (f == 8) {
            ...
            o.find(".slotslide").each(function() {
                var t = e(this).find("div");
                _.add(punchgs.TweenLite.to(t, N / 1e3, { left: 0 - r.width / 2 + "px",
                    top: 0 - r.sloth / 2 + "px",
                    width: r.width * 2 + "px",
                    height: r.sloth * 2 + "px",
                    force3D: "auto",
        ...
        if (f == 12 || f == 13 || f == 14 || f == 15) {
            ...
            if (p != 1) switch (f) {
                case 12:
                    C.add(punchgs.TweenLite.to(G, J, { left: 0 - B + "px",
                        force3D: "auto",
                        scale: z,
                        opacity: U,
                        rotation: r.rotate,
        ...
        if (f == 19 || f == 22) {
            ...
            u.find(".slotslide").each(function(t) {
                ...
                _.add(punchgs.TweenLite.fromTo(n, N / 1e3, {
                    transformStyle: "flat",
                    backfaceVisibility: "hidden", left: 0,
                    rotationY: r.rotate,
                    z: 10,
                    top: 0,
                    scale: 1,
        ...
        if (f == 21 || f == 25) {
            ...
            u.find(".slotslide").each(function(t) {
                var n = e(this);
                C.add(punchgs.TweenLite.fromTo(n, N / 1e3, { left: 0,
                    transformStyle: "flat",
                    rotationX: pt,
                    z: 0,
                    autoAlpha: 0,
                ...
                if (h.find("img").length > 0) {
                    ...
                    if (h.find("iframe").length > 0 || h.find("video").length > 0) {
                        ...
                        if (!h.hasClass("fullscreenvideo")) h.css({
                            "font-size": Z.data("fsize") * r.bh + "px",
                        ...
                        h.find(".frontcorner").css({
                            borderWidth: rt + "px", left: 0 - rt + "px",
    ...
    var q = function(e, n) {
        ...
        if (!e.hasClass("tp-splitted")) {
            ...
            punchgs.TweenLite.set(e, {
                fontSize: Math.round(e.data("fsize") * n.bw) + 5 + "px",
                letterSpacing: Math.floor(e.data("ls") * n.bw) + "px",
                paddingTop: Math.round(e.data("pt") * n.bh) + "px",
                paddingBottom: Math.round(e.data("pb") * n.bh) + "px",
                paddingLeft: Math.round(e.data("pl") * n.bw) + "px",
                paddingRight: Math.round(e.data("pr") * n.bw) + "px",
                marginTop: e.data("mt") * n.bh - 30 + "px",
                marginBottom: e.data("mb") * n.bh + "px",
                marginLeft: e.data("ml") * n.bw + 20 + "px",
                marginRight: e.data("mr") * n.bw + 50 + "px",

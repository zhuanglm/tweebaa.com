<%@ Page Title=""  Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="HomeCollageShare.aspx.cs" Inherits="TweebaaWebApp2.Home.HomeCollageShare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="WebCssAndJs" runat="server">
    ...
    <script src="../MethodJs/homeCollageShare.js" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="WebContent" runat="server">

 <div class="col-md-9">
    <h2><span aria-hidden="true" class="fa fa-share-alt"></span> My Collage Share</h2> 
      <!--Profile Body-->
      ...
      <div class="row content-boxes-v2 margin-bottom-20">
       ...
       <form class="sky-form" role="form" > 
         ...
         <button class="btn-u rounded btn-u-blue" type="button" onclick="DoSearchCollageShare()">Search</button>
       </form>
                 
   <div class="panel margin-bottom-40">

     <table class="table" id="tblCollageDesignList">
<!--
      <thead>
        <tr>

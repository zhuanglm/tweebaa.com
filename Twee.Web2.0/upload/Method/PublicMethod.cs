...
namespace TweebaaWebApp2.Method
{
    public class PublicMethod : System.Web.UI.Page
    {
        ...
        public string ChangeFilePhy(string fileName, string playFile, string imgFile)
        {
            ...
            if (!System.IO.File.Exists(playFile))
            {
                return "";
            }
            ...
            string ss = " -i " + playFile + " -y -ab 56 -ar 22050 -b 500 -r 15 -s " + widthOfFile + "x" + heightOfFile + " " + flv_file;
            FilestartInfo.Arguments = ss;

            //Twee.Comm.CommHelper.WrtLog("change mov to flv=" + ss);

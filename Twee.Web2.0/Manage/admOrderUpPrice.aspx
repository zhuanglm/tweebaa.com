<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admOrderUpPrice.aspx.cs" Inherits="TweebaaWebApp2.Manage.admOrderUpPrice" %>
...
<body class="body" style="overflow:hidden;">
    ...
    <div class="poptrade">
        <div id="fororder" class="bk">
         ...
         <div class="bt_bk2" >
           <asp:Button ID="btnUpPrice" runat="server"  Text=" 改 价 " CssClass="bt_style" OnClick="btnUpPrice_Click" />
           <asp:Button ID="btnUpPay" runat="server"  Text=" 支 付 " CssClass="bt_style" OnClick="btnUpPay_Click" />

         <%-- <asp:Button ID="btnUpClose" Text=" 关 闭 " runat="server" CssClass="bt_style" OnClientClick="closeBox()" />--%>

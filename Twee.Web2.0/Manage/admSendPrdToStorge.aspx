<%@ Page Title=""  Language="C#" MasterPageFile="~/Manage/mstMyAdm.Master" AutoEventWireup="true"
    CodeBehind="admSendPrdToStorge.aspx.cs" Inherits="TweebaaWebApp2.Manage.admSendPrdToStorge" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function selAll() {
            ...
            var obj = document.getElementById("<%=hidIds.ClientID %>"); //hidIds
            obj.value = "";
            for (var i = 0; i < selobj.length; i++) {
                if (!selobj[i].disabled) {
                    selobj[i].checked = true;                    
                    obj.value += selobj[i].value+";";

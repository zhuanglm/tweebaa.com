<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupProductByFocus.aspx.cs" Inherits="TweebaaWebApp2.Mgr.ByFocusMgr.SetupProductByFocus" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function DoSave() {
            ...
            var res = TweebaaWebApp2.Mgr.ByFocusMgr.SetupProductByFocus.SaveProductFocusCate(productIDs, focusCateIDs);
        ...
        function LoadFocusCateCheckboxList() {
            var res = TweebaaWebApp2.Mgr.ByFocusMgr.SetupProductByFocus.GetFocusCateList();
        ...
        function LoadProductFocusCateList(sKeyword, bDispHasNotFocusCate, sProductStatusID) {
            ...
            var res = TweebaaWebApp2.Mgr.ByFocusMgr.SetupProductByFocus.GetFocusCateColumnNameList();
            var obj = eval(res.value);
            var colStruct = [];
            var colItems = [];

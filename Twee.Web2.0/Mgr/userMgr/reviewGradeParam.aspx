<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reviewGradeParam.aspx.cs" Inherits="TweebaaWebApp2.Mgr.userMgr.reviewGradeParam" %>
     ...
     <script type="text/javascript">
      ...
      <script type="text/javascript">
          ...
          function DoublePoints() {
              var res = TweebaaWebApp2.Mgr.userMgr.reviewGradeParam.DoublePoints().value;
              if (res == "success") {
                  alert("Success");

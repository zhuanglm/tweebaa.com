<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="usersEdit.aspx.cs" Inherits="TweebaaWebApp2.Mgr.userMgr.usersEdit" %>
    ...
    <table class="tbtable" style="width:450px;">
        ...
        <script type="text/javascript">
            ...
            function _save() {
                ...
                var res = TweebaaWebApp2.Mgr.userMgr.usersEdit.userSave(id, name, sex, Phone, Birthday, pwd, Email).value;
                if (res == "success") {
                    alert('Edit Success');
                } else {
                    alert('Edit Fail');

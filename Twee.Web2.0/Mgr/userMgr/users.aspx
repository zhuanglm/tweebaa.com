<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="TweebaaWebApp2.Mgr.userMgr.users" %>
    ...
    <script type="text/javascript">
                    ...
                    function _remove(obj) {
                        if (confirm("Confirm to delete selected user?")) {
                            var key = $(obj).attr("dbkey");
                            if (key.length > 0) {
                                var res = TweebaaWebApp2.Mgr.userMgr.users.DeleteUser(key).value;
                                if (res == "success") {

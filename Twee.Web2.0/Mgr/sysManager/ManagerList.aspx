<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerList.aspx.cs" Inherits="TweebaaWebApp2.Mgr.sysManager.ManagerList" %>
...
<body style="padding: 2px;">
    ...
    <thead>
		<tr>
            ...
            <th data-options="field:'6'" align="center" style="width:400px;">Authorized Groups</th>
		</tr>
    </thead>
    <tbody style=" display:none;">
        ...
        <ItemTemplate>
           <tr >
               <td><%#Eval("MgrUser_Name") %></td>
               <!--
               <td><%//#Eval("role").ToString().Trim() == "1" ? "Super Administrator" : "General Administrator"%></td>
               -->
               <td><%#Eval("MgrUser_Active").ToString()=="1"?"Enabled":"Disabled" %></td>

               <td><%#Eval("MgrUser_CreateDate") %></td>
               <td>
                  <a href="javascript:void(0)" onclick="_edit(this)" dbkey="<%#Eval("MgrUser_ID") %>">Edit</a>
                  <a href="javascript:void(0)" onclick="_delete(this)" dbkey="<%#Eval("MgrUser_ID") %>">Delete</a>
               </td>
               <td ><%#GetGrpList(Eval("MgrUser_ID"))%></td>
           </tr>
        </ItemTemplate>
        </asp:Repeater>
	</tbody>
    ...
    <script type="text/javascript">
        ...
        function _delete(obj) {
            if (confirm("Confirm to delete selected items？")) {
                ...
                var res = TweebaaWebApp2.Mgr.sysManager.ManagerList.DeleteUser(guid).value;
                if (res == "success") {

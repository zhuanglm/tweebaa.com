<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proDownMgr.aspx.cs" Inherits="TweebaaWebApp2.Mgr.proManager.proDownMgr" %>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#ddlTypeOne").combobox({
                    valueField: 'value',
                    textField: 'text',
                    data: eval(TweebaaWebApp2.Mgr.proManager.proDownMgr.GetFirstCate().value),
                    onSelect: function (e) {
                        var selectedId = e.value;
                        $("#ddlTypeTwo").combobox("clear");
                        $("#ddlTypeThree").combobox("clear");
                        if (selectedId != "-1") {
                            var res = TweebaaWebApp2.Mgr.proManager.proDownMgr.GetNextCate(selectedId).value;
                            if (res != "fail") {
            ...
            function noPassSave() {
                ...
                if (proid == null || reason == null || proid == "" || $.trim(reason) == "") {
                    ...
                    if ($("#nopassReason").attr('tip') == 'all') {
                        res = TweebaaWebApp2.Mgr.proManager.proDownMgr.UpAll(proid, reason).value; //批量上架
                    } else {
                        res = TweebaaWebApp2.Mgr.proManager.proDownMgr.UpSingle(proid, reason).value; //间个上架
                    }

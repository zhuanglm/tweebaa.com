<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="proEdit.aspx.cs" Inherits="TweebaaWebApp2.Mgr.proManager.proEdit"
...
<body style="padding: 2px;">
    ...
    <table class="tbtable" style="width: 100%;">
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtProName" runat="server" MaxLength="245" Width="600"></asp:TextBox>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtRanking" runat="server" MaxLength="4" Width="100" style="text-align: right"></asp:TextBox> (1000 ~ 1   1000:best 1:worst)
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
            ...
            <td colspan="3">
                <asp:CheckBox ID="chkAllowCollage" runat="server" />Please check if this product can be used for Collage.
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtSuggestPrice" runat="server" style="text-align: right" maxlength="12" Width="100"></asp:TextBox>USD
            </td>
        </tr>
        <tr style="display: none;">
            ...
            <td colspan="3">
                <asp:TextBox ID="txtSupplyPrice" runat="server" style="text-align: right" maxlength="12" Width="100"></asp:TextBox>USD
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
            ...
            <td colspan="3">
                <asp:TextBox ID="txtSalePrice" runat="server" style="text-align: right" maxlength="12" Width="100"></asp:TextBox>USD
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
        ...
        <tr>
          ...
          <tr>
            ...
            <td colspan="3">
                ...
                Featured Product: <asp:CheckBox ID="ckbisFeatured" runat="server" />&nbsp;&nbsp;
                Display Spec Name:  <asp:CheckBox ID="ckDisplaySpecName" runat="server" />&nbsp;&nbsp;
                Display Spec Color: <asp:CheckBox ID="ckDisplaySpecColor" runat="server" />
            </td>
        </tr>
 
        <tr>
            <td class="title" style="width: 120px;">
                Suggester Is Supplier
            </td>
            <td colspan="3" >
                <asp:Label ID="lblIsSupplier" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:Label ID="lblSupplierWebsite" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:Label ID="lblSupplierEmail" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="title" style="width: 120px;">
    ...
    <script type="text/javascript">
        ...
        function verfy() {
            ...
            // check ranking
            var ranking = $("#txtRanking").val();
            if (ranking == "") {
                alert("Please input the ranking of this product.");
                $("#txtRanking").focus();
                return false;
            }
            if (!checkInteger(ranking)) {
                alert("Please input a valid ranking number.");
                $("#txtRanking").focus();
                return false;
            }

            if (parseInt(ranking) < 1 || parseInt(ranking) > 1000) {
                alert("Please input a valid ranking number (1000 ~ 1).");
                $("#txtRanking").focus();
                return false;
            }

...
<body style="background-color: #1c77ac; -background-image: url(images/light???.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
    ...
    <div class="logintop">
        <span>Welcome to Tweebaa.com backend management system</span>
        <ul>
            <li><a href="#">Home</a></li>
            <li><a href="#">Help</a></li>
        ...
        <form runat="server" id="from1">
            <div class="loginbox">
                <ul>
                    ...
                    <li>
                        <asp:Button ID="BtnLogin" runat="server" Text="Login" CssClass="loginbtn" OnClientClick="javascript:return login()" OnClick="BtnLogin_Click" />
                        <label>
    ...
    <div class="loginbm">Welcome to Tweebaa.com backend management system</div>
    <script type="text/javascript">
        function login() {

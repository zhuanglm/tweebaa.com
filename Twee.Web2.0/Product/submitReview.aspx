...
<%=sMetaTag%>
    ...
    <script src="../MethodJs/submitReview.js?v=20160129" type="text/javascript"></script>
...
<%}
 ...
 <div class="margin-bottom-15"></div>
   ...
   <ul class="list-inline add-to-myevaluate add-to-wishlist-brd">
    ...
    <!--=== End Shop Product ===--> 
     <!--=== Content Medium ===-->
    <div class="content-md container " style="background-color:#fff;">
        <div class="tab-v6" >
            <ul class="nav nav-tabs" role="tablist">
                <li class="active" style="margin-top:3px;"><a href="#description" role="tab" data-toggle="tab">Description</a></li>
         ...
         <!--=== Illustration v2 ===-->
    <div class="container">
        <div class="illustration-v2 margin-bottom-60" style="padding-top:20px;">
            <div class="customNavigation margin-bottom-25">
                <a class="owl-btn prev rounded-x"><i class="fa fa-angle-left"></i></a><span style="font-size:20px;padding:0px 10px;">Product you may like</span>

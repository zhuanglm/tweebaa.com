    ...
    function (t) {
        ...
        function l(t, e) {
            ...
            function f(t) {
                ...
                f = !s || !C.test(t.tagName) || !(s = s.match(j)),
                d = !l || !u || "100%" === l || "100%" === u,
                g = f && d,
                p = {};
                if (p.width = 0, p.height = 0, p.toBeParsed = g, g) return p;
                if (f) return p.width = _(l), p.height = _(u), p;
                if (h = -parseFloat(s[1]), c = -parseFloat(s[2]), e = parseFloat(s[3]), i = parseFloat(s[4]), d ? (p.width = e, p.height = i) : (p.width = _(l), p.height = _(u), o = p.width / e, a = p.height / i), a = o = o > a ? a : o, 1 === o && 1 === a && 0 === h && 0 === c) return p;
                if (r = " matrix(" + o + " 0 0 " + a + " " + h * o + " " + c * a + ") ", "svg" === t.tagName) {
                    for (n = t.ownerDocument.createElement("g"); null != t.firstChild; ) n.appendChild(t.firstChild);
                    t.appendChild(n)
                } else n = t, r = n.getAttribute("transform") + r;
                return n.setAttribute("transform", r), p
            }
            ...
            v(p, {
                ...
                createSVGFontFacesMarkup: function (t) {
                    for (var e = "", i = 0, r = t.length; r > i; i++) "text" === t[i].type && t[i].path && (e += ["@font-face {", "font-family: ", t[i].fontFamily, "; ", "src: url('", t[i].path, "')", "}"].join(""));
        ...
        fabric.util.object.extend(fabric.Canvas.prototype, {
            ...
            _performTransformAction: function (t, e, i) {
                var r = i.x,
                    ...
                    s = e.target,
                    o = e.action;
                "rotate" === o ? (this._rotateObject(r, n), this._fire("rotating", s, t)) : "scale" === o ? (this._onScale(t, e, r, n), this._fire("scaling", s, t)) : "scaleX" === o ? (this._scaleObject(r, n, "x"),
                    this._fire("scaling", s, t)) : "scaleY" === o ? (this._scaleObject(r, n, "y"), this._fire("scaling", s, t)) : (this._translateObject(r, n), this._fire("moving", s, t), this.setCursor(this.moveCursor))
            },
            ...
            _renderChar: function (t, e, i, r, n, s, o, a) {
                ...
                if (l) {
                    var f = l.stroke || this.stroke,
                        d = l.fill || this.fill;
                    e.save(), h = this._applyCharStylesGetWidth(e, n, i, r, l), c = this._getHeightOfChar(e, n, i, r), d && e.fillText(n, s, o), f && e.strokeText(n, s, o), this._renderCharDecoration(e, l, s, o, u, h, c), e.restore(), e.translate(h, 0)
                } else "strokeText" === t && this.stroke && e[t](n, s, o), "fillText" === t && this.fill && e[t](n, s, o), h = this._applyCharStylesGetWidth(e, n, i, r), this._renderCharDecoration(e, null, s, o, u, h, this.fontSize), e.translate(e.measureText(n).width, 0)
            },
    ...
    function () {
        ...
        fabric.util.object.extend(fabric.IText.prototype, {
            ...
            insertChar: function (t, e, i) {
                ...
                this.text = this.text.slice(0, this.selectionStart) + t + this.text.slice(this.selectionEnd), this._textLines = this._splitTextIntoLines(), this.insertStyleObjects(t, r, i), this.setSelectionStart(this.selectionStart + 1), this.setSelectionEnd(this.selectionStart), e || (this.canvas && this.canvas.renderAll(), this.setCoords(), this.fire("changed"), this.canvas && this.canvas.fire("text:changed", {
                    target: this
                }))
            },
